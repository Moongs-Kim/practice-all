...
public class MethodRefEx2 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(instanceMethod1.apply(1));
        System.out.println(instanceMethod2.apply(1));

        // 3. 생성자 참조
        Function<String, Person> supplier1 = name -> new Person(name);
        Function<String, Person> supplier2 = Person::new;

        System.out.println(supplier1.apply("Kim"));
        System.out.println(supplier2.apply("Lee"));
